...
>(
  (
    { className, children, icon, iconClassName, hideIcon = false, ...props },
    ref
  ) => (
      ...
      {!hideIcon && (
        <SelectPrimitive.Icon asChild>
          {icon || (
            <ChevronDown
              className={cn(
                "h-5 w-5 opacity-50 transition-transform duration-200 data-[state=open]:rotate-180",
                iconClassName
              )}
              color="#292D32"
            />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className="h-5 w-5" color="#292D32" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className="h-5 w-5" color="#292D32" />
  </SelectPrimitive.ScrollDownButton>
));
...
const SelectItem = React.forwardRef<
  ...
  SelectItemProps
>(({ className, children, noCheckIcon = false, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        {!noCheckIcon && <Check className="h-4 w-4" />}
      </SelectPrimitive.ItemIndicator>
    </span>
